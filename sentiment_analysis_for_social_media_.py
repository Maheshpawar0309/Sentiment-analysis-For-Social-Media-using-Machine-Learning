...
df = pd.read_csv('/content/drive/MyDrive/Colab Notebooks/vaccination_tweets.csv')
...
# Apply sentiment polarity function
...
# Train Linear Support Vector Classifier (LinearSVC) model
SVCmodel = LinearSVC()
SVCmodel.fit(x_train, y_train)

# Evaluate Linear Support Vector Classifier (LinearSVC) model
...
# Display confusion matrix and classification report for Multinomial Naive Bayes
...
nb_grid_search = GridSearchCV(MultinomialNB(), nb_grid)
